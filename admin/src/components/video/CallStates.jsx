...
/**
 * Premium Error, loading, and ended state components for the doctor/admin video call flow.
 */
...
export const CallLoading = () => (
  <div className="min-h-[80vh] flex flex-col items-center justify-center gap-6 bg-slate-950 rounded-3xl p-8 border border-slate-800 shadow-2xl relative overflow-hidden">
    <div className="absolute w-[400px] h-[400px] bg-emerald-600/10 rounded-full blur-[100px] -top-20 -left-20 animate-pulse" />
    <div className="absolute w-[400px] h-[400px] bg-teal-600/10 rounded-full blur-[100px] -bottom-20 -right-20 animate-pulse" style={{ animationDelay: '1s' }} />

    <div className="relative z-10 flex flex-col items-center">
      <div className="relative mb-8">
        <div className="absolute -inset-4 rounded-full bg-emerald-500/20 blur-xl animate-pulse" />
        <div className="w-24 h-24 rounded-3xl bg-slate-900/80 border border-slate-700/80 backdrop-blur-xl flex items-center justify-center shadow-2xl shadow-emerald-500/20 relative">
          <div className="w-14 h-14 border-4 border-emerald-500 border-t-transparent rounded-full animate-spin" />
        </div>
        <div className="absolute -bottom-1 -right-1 w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center border-4 border-slate-900 shadow-lg animate-bounce">
      ...
      <div className="text-center max-w-md">
        <span className="px-4 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 text-xs font-semibold uppercase tracking-widest mb-3 inline-block">
          Secured Medical Line
        </span>
        <h2 className="text-2xl font-bold text-white mb-2 tracking-tight">
          Setting up Doctor Consultation Room
        </h2>
        <p className="text-slate-400 text-sm leading-relaxed">
          Establishing a secure, HIPAA-compliant encrypted WebRTC channel...
        </p>
      </div>
    </div>
  </div>
  ...
  <div className="min-h-[80vh] flex flex-col items-center justify-center gap-6 bg-slate-950 rounded-3xl p-8 border border-slate-800 shadow-2xl relative overflow-hidden">
    ...
    <div className="relative z-10 flex flex-col items-center">
      ...
      <div className="text-center max-w-md mb-8">
        ...
        <h2 className="text-2xl font-bold text-white mb-2 tracking-tight">
          Unable to start consultation room
        </h2>
      ...
      <div className="flex flex-wrap gap-4 justify-center">
        {onRetry && (
          <button
            onClick={onRetry}
            className="px-6 py-3 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white rounded-2xl font-semibold transition-all duration-300 flex items-center gap-2 text-sm shadow-xl shadow-emerald-600/30 transform active:scale-95"
          >
    ...
    <div className="relative z-10 flex flex-col items-center">
      ...
      <div className="text-center max-w-md mb-8">
        ...
        <p className="text-slate-300 text-sm leading-relaxed">
          The secure medical video session has been successfully closed.
        </p>
      </div>
      <button
        onClick={onBack}
        className="px-8 py-4 bg-gradient-to-r from-emerald-600 via-teal-600 to-emerald-700 hover:from-emerald-500 hover:to-teal-500 text-white rounded-2xl font-bold transition-all duration-300 shadow-xl shadow-emerald-600/30 flex items-center gap-3 transform active:scale-95 text-base"
      >
