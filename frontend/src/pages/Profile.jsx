...
import { LogOut, ShieldCheck, CalendarDays, User as UserIcon, Mail } from "lucide-react";
            ...
            <div className="space-y-6">
              <div className="bg-primary rounded-lg p-6 text-white grid md:grid-cols-[auto,1fr] gap-4 items-center">
                <div className="flex items-center justify-center w-14 h-14 bg-white bg-opacity-20 rounded-full mx-auto md:mx-0 border-2 border-white border-opacity-30">
                  <span className="text-2xl font-bold">{me.name?.charAt(0).toUpperCase()}</span>
                </div>
                <div>
                  <h2 className="text-xl font-bold">Hello, {me.name}</h2>
                  <p className="text-white mt-0.5 flex items-center gap-2 text-sm font-medium"><Mail className="w-4 h-4" /> {me.email}</p>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-3">
                <div className="p-3 bg-gray-50 rounded-lg border border-gray-200">
                  ...
                  <div className="text-gray-900 font-semibold break-all text-sm">{me.email}</div>
                </div>
                <div className="p-3 bg-gray-50 rounded-lg border border-gray-200">
                  <div className="flex items-center gap-2 text-gray-700 mb-1">
                  ...
                  <div className="text-primary font-semibold capitalize text-sm">{me.role || "user"}</div>
                </div>
                <div className="p-3 bg-gray-50 rounded-lg border border-gray-200">
                  <div className="flex items-center gap-2 text-gray-700 mb-1">
                  ...
                  <div className="text-emerald-700 font-semibold text-sm">Active</div>
                </div>
              </div>
