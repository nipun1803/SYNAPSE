  ...
  return (
    <StreamVideo client={client}>
      <StreamCall call={call}>
        <div className="min-h-[85vh] flex flex-col rounded-3xl overflow-hidden shadow-[0_0_100px_rgba(0,0,0,0.55)] border border-slate-800 bg-slate-950 m-4 sm:m-6">
          {/* Header */}
          <div className="flex items-center justify-between px-6 py-4 bg-slate-900/90 backdrop-blur-xl border-b border-slate-800/80 z-20">
            <div className="flex items-center gap-3.5">
              <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-rose-500/10 border border-rose-500/30 text-rose-400 text-xs font-semibold tracking-wider">
            ...
            <div className="flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-400 text-xs font-medium">
              <Shield className="w-4 h-4 text-blue-400" />
              <span className="hidden sm:inline">256-bit WebRTC Encrypted</span>
