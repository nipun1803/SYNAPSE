...
const VideoCall = () => {
  ...
  const initWebRTC = useCallback(async () => {
    try {
      ...
      // We will create an offer when we join. This allows the second person to answer.
  ...
  }, [socket, initWebRTC, appointmentId]);
  ...
  const handleEndCall = (emitEvent = true) => {
    ...
    if (emitEvent && socket) {
      socket.emit('video_ended', { appointmentId, endedBy: userData?._id });
    }
  };
