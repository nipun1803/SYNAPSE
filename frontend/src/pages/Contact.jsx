          ...
          <Card className='border-gray-200 shadow-md'>
            <CardContent className='p-6'>
              <div className='flex items-start gap-3 mb-4'>
                ...
                <div>
                  <h2 className='text-lg font-semibold text-gray-900 mb-2'>Our Office</h2>
              ...
              <div className='space-y-3 mt-4 pt-4 border-t border-gray-200'>
                <div className='flex items-center gap-3 text-gray-600'>
                  ...
                  <span className='text-sm'>Tel: (415) 555-0132</span>
                </div>
                <div className='flex items-center gap-3 text-gray-600'>
                  <Mail className='w-4 h-4 text-blue-600' />
                  <span className='text-sm'>Email: synapse@gmail.com</span>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className='border-gray-200 shadow-md'>
            <CardContent className='p-6'>
              <div className='flex items-start gap-3 mb-4'>
                ...
                <div>
                  <h2 className='text-lg font-semibold text-gray-900 mb-2'>Careers at Synapse</h2>
                  <p className='text-gray-600 leading-relaxed'>
