...
/**
 * Premium Call control bar with mic toggle, camera toggle, screen share, and leave call.
 * Uses Stream SDK hooks for device state management with state-of-the-art glassmorphism UI.
 */
