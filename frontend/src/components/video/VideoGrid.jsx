...
/**
 * Premium Video grid displaying local and remote participant video feeds.
 * Adapts layout based on participant count with state-of-the-art UI/UX.
 */
const VideoGrid = () => {
    ...
    return (
      <div className="flex-1 flex items-center justify-center bg-slate-950 min-h-[600px]">
        <div className="text-center relative z-10 max-w-md p-8 rounded-3xl bg-slate-900/60 border border-slate-800/80 backdrop-blur-2xl shadow-2xl flex flex-col items-center">
          ...
          <h3 className="text-white font-bold text-xl mb-2">Joining Secure Room...</h3>
          <p className="text-slate-400 text-sm">Establishing end-to-end encrypted video channel</p>
        </div>
      </div>
    );
  }
      ...
      {isAlone ? (
        <>
          ...
          <div className="absolute inset-0 flex items-center justify-center bg-slate-950/85 pointer-events-none overflow-hidden px-4">
            ...
            <div className="absolute w-[500px] h-[500px] bg-blue-600/15 rounded-full blur-[120px] -top-20 -left-20 animate-pulse" />
            <div className="absolute w-[500px] h-[500px] bg-indigo-600/15 rounded-full blur-[120px] -bottom-20 -right-20 animate-pulse" style={{ animationDelay: '1s' }} />

            <div className="text-center relative z-10 max-w-lg px-8 py-12 rounded-3xl bg-slate-900/70 border border-slate-800 backdrop-blur-2xl shadow-[0_0_80px_rgba(37,99,235,0.15)] flex flex-col items-center">
              <div className="relative mb-6">
                <div className="absolute -inset-4 rounded-full bg-blue-500/20 blur-xl animate-pulse" />
                <div className="w-20 h-20 rounded-2xl bg-gradient-to-tr from-blue-600 to-indigo-600 flex items-center justify-center shadow-xl shadow-blue-500/30 relative transform rotate-3 hover:rotate-0 transition-transform duration-500">
                  <Users className="w-10 h-10 text-white" />
                </div>
              </div>
              <span className="px-4 py-1.5 rounded-full bg-blue-500/10 border border-blue-500/30 text-blue-400 text-xs font-semibold uppercase tracking-wider mb-3 flex items-center gap-2">
                <span className="w-2 h-2 rounded-full bg-blue-500 animate-ping" /> Secure Video Room Active
              </span>
              ...
              <p className="text-slate-300 text-sm max-w-sm mb-8 leading-relaxed">
                Your consultation session is live. The room will instantly connect with HD video as soon as they enter.
              </p>
              <div className="flex items-center justify-center gap-2 bg-slate-950/80 px-6 py-3 rounded-2xl border border-slate-800 shadow-inner">
                ...
                <span className="text-xs font-medium text-slate-300">Encrypted P2P connection standing by</span>
              </div>
            </div>
          </div>
        </>
        ...
        <>
          ...
          <div className="absolute bottom-28 right-8 w-48 sm:w-56 aspect-[3/4] bg-slate-950 rounded-2xl overflow-hidden border border-white/20 shadow-[0_20px_60px_rgba(0,0,0,0.8)] ring-4 ring-blue-500/20 z-20 transition-all duration-300 hover:scale-105 hover:border-blue-400 hover:shadow-blue-500/25">
            <div className="absolute top-3 left-3 z-30 px-2 py-1 rounded-md bg-slate-950/80 backdrop-blur-md text-[11px] font-medium text-white border border-white/15 flex items-center gap-1.5 shadow-md">
              <span className="w-1.5 h-1.5 bg-emerald-500 rounded-full animate-pulse" /> You
            </div>
            <ParticipantView
